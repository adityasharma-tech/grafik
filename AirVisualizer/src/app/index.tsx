  ...
  return (
    ...
    >
      <header className="bg-white pl-8 pr-3 md:min-w-[70vw] w-[90vw] md:py-0 py-5 z-30 fixed top-5 left-[50%] right-[50%] -translate-x-[50%] rounded-xl flex flex-row justify-between items-center">
        ...
        <div>
          <ul className="md:flex hidden text-sm gap-x-8 font-medium underline-offset-3 text-neutral-800 py-5">
            ...
            <li className="hover:underline cursor-pointer">What it does?</li>
            <li className="hover:underline cursor-pointer">FAQ</li>
            <li className="hover:underline cursor-pointer">Contact</li>
          </ul>
        </div>
        <div>
          <a href="https://adityasharma.live/#contact"
          target="_blank"
      ...
      <main className="mt-20 py-20 px-5">
        <div className="flex-col items-center flex justify-center gap-y-7">
        ...
        <section className="flex-col items-center text-neutral-800 my-10 flex justify-center gap-y-2">
            ...
            {[
              ...
              >
                <div className="border border-gray-100 h-full bg-zinc-50 p-3 rounded-lg">
                  ...
                  <a target="_blank" href={_.href} className="flex gap-x-4 items-center cursor-pointer text-emerald-700 font-medium mt-5 group pr-4">
            ...
            <div className="border border-gray-300 bg-white p-1.5 mt-5 md:w-7xl rounded-xl">
              <div className="border border-gray-100 h-full bg-zinc-50 rounded-lg flex justify-between">
                <div className="p-3 flex flex-col justify-center">
                  ...
                  <div className="text-neutral-700">
                    <span>
                      We provide multiple data plotting and logging in real-time, visualizing your data in realtime makes easier for you to debug your IoT project. 
                    </span>
                  </div>
        ...
        <footer className="bg-neutral-900 py-10 px-10 grid gap-y-10 md:grid-cols-2 text-neutral-100">
            <div>
              <img src="logo.png" className="h-10"/>
              <div className="max-w-xl text-sm mt-6">
                Studio for visualizing Real-Time IoT data to our dashboard. It offers to debug you faster and optimized for running with no log.
              </div>
            </div>
            <div className="flex flex-col gap-y-3">
              ...
              <a href="https://x.com/@AdityaSharma626">Developed by: <strong className="font-semibold hover:underline underline-offset-3">Aditya Sharma</strong></a>
              <a href="mailto:aditya@adityasharma.live" className="hover:underline underline-offset-2">aditya@adityasharma.live</a>
              <a href="https://www.adityasharma.live" target="_blank" className="hover:underline underline-offset-2">www.adityasharma.live</a>
            </div>
        </footer>
    </div>
  );
